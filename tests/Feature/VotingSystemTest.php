...
class VotingSystemTest extends TestCase
{
    ...
    public function test_admin_can_import_students_excel()
    {
        ...
        $file = \Illuminate\Http\UploadedFile::fake()->createWithContent('test_students.csv', "NIS,NAMA LENGKAP,KELAS\n9001,Siswa Fast 1,XI TKJ 1\n9002,Siswa Fast 2,XI TKJ 2\n");
    ...
    public function test_admin_can_import_students_semicolon_csv_and_update_mode()
    {
        $admin = Admin::create([
        ...
        $file = \Illuminate\Http\UploadedFile::fake()->createWithContent(
            'test_students_indo.csv',
            "\xEF\xBB\xBFNIS;NAMA LENGKAP;KELAS\n9001;Nama Baru Updated;XI TKJ 1\n9003;Siswa Baru 3;XI TKJ 2\n"
        );
